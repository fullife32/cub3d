...
static const char	*g_error[MAX_ERROR] = {
	...
	"Incorrect width resolution entered\n",
	...
	"Too many elements have been entered for resolution\n",
	"Incorrect height resolution entered\n",
	"Too many elements have been entered for a texture\n"
};
